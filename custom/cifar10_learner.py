...
from cifar10_data_splitter import CIFAR10_ROOT
from cifar10_dataset import CIFAR10_Idx
...
class CIFAR10Learner(Learner):  # also supports CIFAR10ScaffoldLearner
    ...
    def initialize(self, parts: dict, fl_ctx: FLContext):
        ...
        #self.scheduler = torch.optim.lr_scheduler.StepLR(self.optimizer, step_size=7, gamma=0.1) # Learning Scheduler
